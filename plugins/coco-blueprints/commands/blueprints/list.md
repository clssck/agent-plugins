---
description: "List available blueprints with metadata."
---
...
Read all blueprint meta.yaml files from the `${CLAUDE_PLUGIN_ROOT}/blueprints/` directory and display them in a formatted table.
...
1. Find all `meta.yaml` files in subdirectories of the `${CLAUDE_PLUGIN_ROOT}/blueprints/` folder
