...
| Tasks | `snow.executable.type` = `'TASK'`; `INFORMATION_SCHEMA.TASK_HISTORY`; `SNOWFLAKE.ACCOUNT_USAGE.TASK_HISTORY`; `SNOWFLAKE.ACCOUNT_USAGE.SERVERLESS_TASK_HISTORY` | [`../../../../data-engineering/snowflake-tasks/SKILL.md`](../../../../data-engineering/snowflake-tasks/SKILL.md) | **Active** |
| Data Quality | `SNOWFLAKE.LOCAL.DATA_QUALITY_MONITORING_RESULTS`; `SNOWFLAKE.LOCAL.DATA_QUALITY_MONITORING_EXPECTATION_STATUS`; `SNOWFLAKE.ACCOUNT_USAGE.DATA_METRIC_FUNCTION_REFERENCES`; `SNOWFLAKE.ACCOUNT_USAGE.DATA_QUALITY_MONITORING_USAGE_HISTORY` | [`../../../../data-governance/data-quality/SKILL.md`](../../../../data-governance/data-quality/SKILL.md) | **Active** |
