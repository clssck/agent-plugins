...
This app renders a completed Spark Java → Snowpark Connect validation run as an
...
uv run --project data-engineering/spark-migration/snowpark-connect \
  streamlit run data-engineering/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/scripts/report/validation_report_app.py \
