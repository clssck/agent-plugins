...
### Step 0.5: Progress UI (Experimental — Snowpark Connect path only)
...
[`snowpark-connect/migrate-pyspark-to-snowpark-connect/SKILL.md`](snowpark-connect/migrate-pyspark-to-snowpark-connect/SKILL.md).
