...
description: >-
  ...
  agentic optimization, sql_correctness, SQL generation accuracy, audit semantic view,
...
│
├─ Agent operations (create, edit, test, download, upload agent)
│  └─> Load agent/SKILL.md
│
...
└─ Unclear intent → Ask:
   "What would you like to do?
    ...
    2. Work with Cortex Agents (create, edit, test, download, upload)
    3. Debug a Cortex Agent request"
```

| Domain | Trigger Phrases | Route To |
|--------|----------------|----------|
| **Semantic View** | create / build / edit / modify / update a semantic view; add a table, column, metric; upload or deploy a YAML; download or export a semantic view; generate or improve descriptions; audit a semantic view; validate a semantic-view YAML; bulk-validate verified queries (VQRs); mine VQR suggestions; suggest metrics, filters, or facts; run agentic optimization; import a Tableau workbook (.twb/.twbx/.tds/.tdsx); import a Power BI file (.pbit/.pbix); import an OSI (Open Semantic Interchange, also known as Ossie) YAML model | `semantic-view/SKILL.md` |
...
### 2. **Agent** — Create, edit, test, download, and upload Cortex Agents
